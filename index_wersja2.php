              ...
              <div class="row pt-3">
                ...
                <div class="col-md-6 col-sm-12 col-12 pt-3 pb-3 rounded-left mx-auto" style="box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.08);">
                  <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                      <div class="row border rounded mx-0 mt-0 mb-3" id="zamek" style="border-color: rgba(0, 0, 0, 0.08) !important;">
                        ...
                        <div class="col-md-7 col-12 pt-3 pb-3">
                          ...
                          <div class="col pt-3">
                            <div class="row">
                              <div class="col-1 col-sm-1 col-md-2 col-lg-2 d-md-none d-lg-block pr-0">
                                <img src="vegan_pl_PL.svg" style="max-width: 24px;">
                              </div>
                              <div class="col-11 col-sm-11 col-md-12 col-lg-10">
                          ...
                          <div class="col pt-2">
                            <div class="row">
                              <div class="col-1 col-sm-1 col-md-2 col-lg-2 d-md-none d-lg-block pr-0">
                                <img src="1.svg" style="max-width: 24px;">
                              </div>
                              <div class="col-11 col-sm-11 col-md-12 col-lg-10">
                          ...
                          <div class="col py-2">
                            <div class="row">
                              <div class="col-1 col-sm-1 col-md-2 col-lg-2 d-md-none d-lg-block pr-0">
                                <img src="2.svg" style="max-width: 24px;">
                              </div>
                              <div class="col-11 col-sm-11 col-md-12 col-lg-10">
                                Bez laktozy
                              </div>
                          ...
                          <div class="w-100"></div>
                          <div class="row">
                            <div class="col-6 col-sm-6 col-md-12 col-lg-6 pb-2">
                              <button class="btn btn-more rounded btn-block" type="button" data-toggle="modal" data-target=".bd-example-modal-lg">Więcej...</button>
                                      ...
                                      <div class="container">
                                        ...
                                        <div class="row">
                                          <div class="col-12 col-sm-12 col-md-12 col-lg-6 pt-3">
                                            <div class="row">
                                              <div class="col-2">
                                                <img src="vegan_pl_PL.svg" style="max-width: 34px">
                                              </div>
                                          ...
                                          <div class="col-12 col-sm-12 col-md-12 col-lg-6 pt-3">
                                            <div class="row">
                                              <div class="col-2">
                                                <img src="1.svg" style="max-width: 34px">
                                              </div>
                                              <div class="col" style="line-height: 34px;">
                                                Wysoka zawartość błonnika
                                              </div>
                                          ...
                                          <div class="col-12 col-sm-12 col-md-12 col-lg-6 pt-3">
                                            <div class="row">
                                              <div class="col-2">
                                                <img src="2.svg" style="max-width: 34px">
                                              </div>
                                              <div class="col" style="line-height: 34px;">
                                                Bez laktozy
                                              </div>
                                          ...
                                          <div class="col-12 col-sm-12 col-md-12 col-lg-6 pt-3">
                                            <div class="row">
                                              <div class="col-2">
                                                <img src="3.svg" style="max-width: 34px">
                                              </div>
                                              <div class="col" style="line-height: 34px;">
                                        ...
                                        <div class="row">
                                          <div class="col pt-3 font-weight-light">
                                            Baza jaką są płatki owsiane stanowi idealną podstawę dla musli, a możliwość łączenia jej z dowolnymi składnikami sprawia, że całość smakuje dokładnie tak jak lubisz!
                                          </div>
                                        </div>
                                        <div class="row">
                            ...
                            <div class="col-6 col-sm-6 col-md-12 col-lg-6">
                              <button class="btn btn-add rounded btn-block font-weight-bold" type="button" onclick="location.href=''">Dodaj</button>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row border rounded mx-0 mt-0 mb-3" id="zamek" style="border-color: rgba(0, 0, 0, 0.08) !important;">
                        <div class="col-md-5 col-12 py-2">
                          <center>
                            <img src="168.svg" class="align-middle m-2 photo" alt="...">
                          </center>
                        </div>
                        <div class="col-md-7 col-12 pt-3 pb-3">
                          <div class="col font-weight-bold">
                          ...
                          <div class="w-100"></div>
                          <div class="col font-weight-light">
                            Płatki owsiane pieczone w miodzie
                          </div>
                          <div class="col pt-3">
                            <div class="row">
                              <div class="col-1 col-sm-1 col-md-2 col-lg-2 d-md-none d-lg-block pr-0">
                                <img src="4.svg" style="max-width: 24px;">
                              </div>
                              <div class="col-11 col-sm-11 col-md-12 col-lg-10">
                                Oszczędność C02
                              </div>
                          ...
                          <div class="col pt-2">
                            <div class="row">
                              <div class="col-1 col-sm-1 col-md-2 col-lg-2 d-md-none d-lg-block pr-0">
                                <img src="5.svg" style="max-width: 24px;">
                              </div>
                              <div class="col-11 col-sm-11 col-md-12 col-lg-10">
                                Bez dodatku oleju palmowego
                              </div>
                            </div>
                          </div>
                          <div class="col py-2">
                          ...
                          <div class="row">
                            <div class="col-6 col-sm-6 col-md-12 col-lg-6 pb-2">
                              <button class="btn btn-more rounded btn-block" type="button" data-toggle="modal" data-target=".modal2">Więcej...</button>
                              <div class="modal fade modal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      <h5 class="modal-title font-weight-bold" id="exampleModalLongTitle">Crunchy Honey Granola</h5>
                                    </div>
                                    <div class="modal-body">
                                      <div class="container">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                          <div class="col-12 col-sm-12 col-md-12 col-lg-6 pt-3">
                                            <div class="row">
                                              <div class="col-2">
                                                <img src="4.svg" style="max-width: 34px">
                                              </div>
                                              <div class="col" style="line-height: 34px;">
                                                Oszczędność C02
                                              </div>
                                          ...
                                          <div class="col-12 col-sm-12 col-md-12 col-lg-6 pt-3">
                                            <div class="row">
                                              <div class="col-2">
                                                <img src="5.svg" style="max-width: 34px">
                                              </div>
                                              <div class="col" style="line-height: 34px;">
                                                Bez dodatku oleju palmowego
                                              </div>
                                        ...
                                        <div class="row">
                                          <div class="col pt-3 font-weight-light">
                                            Bazą naszej granoli są organiczne, pieczone płatki owsiane słodzone złocistym miodem, które smakują nie tylko przyjemnie słodko, ale są także wyjątkowo chrupiące! Szczególnie polecamy łączenie Crunchy Honey Granola z płatkami kokosowymi, które podkreślają wyjątkowy smak granoli. Koniecznie musisz spróbować! Ten składnik powoduje niską emisje CO2. Lepiej dla naszego klimatu.
                                          </div>
                                        </div>
                                        <div class="row">
                                          <div class="col pt-3" style="font-size: 12px;">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-4 pb-3 rounded-right">
                  <div id="visualization" class="sticky-top pt-3">
                    <div class="row border rounded mx-1 mt-1 mb-3" style="box-shadow: 0px 10px 10px rgba(0, 0, 0, 0.08); border-color: rgba(0, 0, 0, 0.08) !important;">
                      ...
                      <div class="w-100"></div>
                      <div class="col mx-2 p-1 border-top-0 border" style="display: none; border-color: rgba(0, 0, 0, 0.08) !important;" id="myDIV">
                        <div class="row">
                          <div class="col-3 my-auto pl-4">
                            <button class="btn btn-plus fas fa-trash"></button>
                          </div>
                          <div class="col-9 my-auto pr-4 d-flex justify-content-end">
                            Baza ciastka
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col pt-1 m-1 " style="cursor: pointer;" onclick="myFunction1()">
                        <div class="row">
                          ...
                          <div class="col my-auto d-flex justify-content-end">
                            <div id="value_skladnik_1">1</div>
                          </div>
                        </div>
                      </div>
                      <div class="w-100"></div>
                      <div class="col mx-2 p-1 border rounded" style="display: none; border-color: rgba(0, 0, 0, 0.08) !important" id="myDIV1">
                        <div class="row">
                          <div class="col-3 my-auto pl-4">
                            <button id="skladnik_1" class=""></button>
                             <script>
                              var text = document.getElementById("value_skladnik_1").innerHTML;
                              if (text == "1") {
                                  document.getElementById("skladnik_1").className = "btn btn-plus fas fa-trash";
                                }
                              else {
                                document.getElementById("skladnik_1").className = "btn btn-plus fas fa-minus";
                              }
                            </script>
                          </div>
                          <div class="col-3 my-auto pr-3">
                          ...
                          <div class="col-6 my-auto pr-4 d-flex justify-content-end">
                            Typ składniku
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col pt-1 m-1" style="cursor: pointer;" onclick="myFunction2()">
                        <div class="row pb-1">
                          ...
                          <div class="col my-auto d-flex justify-content-end">
                            <div id="value_skladnik_2">Numer</div>
                          </div>
                        </div>
                      </div>
                      <div class="w-100"></div>
                      <div class="col mx-2 mb-2 p-1 border rounded" style="display: none; border-color: rgba(0, 0, 0, 0.08) !important" id="myDIV2">
                        <div class="row">
                          <div class="col-3 my-auto pl-4">
                            <button id="skladnik_2" class=""></button>
                             <script>
                              var text = document.getElementById("value_skladnik_2").innerHTML;
                              if (text == "1") {
                                  document.getElementById("skladnik_2").className = "btn btn-plus fas fa-trash";
                                }
                              else {
                                document.getElementById("skladnik_2").className = "btn btn-plus fas fa-minus";
                              }
                            </script>
                          </div>
                          <div class="col-3 my-auto pr-3">
                    ...
                    <div class="row border mx-1 mb-1 mt-2 p-2" style="box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.08); border-color: rgba(0, 0, 0, 0.08) !important;">
                      Wizualizacja
                    </div>
