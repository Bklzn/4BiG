...
<div class="container-login">
    		...
    		<div class="row">
      		...
      		<div class="col-8 col-sm-8 col-md-6 col-lg-4 pb-5">
      			<div class="display-4 d-flex justify-content-center pt-5 pb-2 ">
      				<i class="fas fa-user-plus" style="color: #49403f"></i>
      			</div>
      			...
      			<div class="d-flex justify-content-center pt-1">
      				<form>
	      				<div class="form">
	  		  			...
	  		  			<div class="input-group txtShowDiv mb-2 mr-sm-2 pb-5">
   			 					<input type="password" id="password" class="form__input" autocomplete="new-password" placeholder=" " onfocus="document.getElementById('show_hide').style.display='block'; document.getElementById('show2').style.display='none'" onblur="document.getElementById('show_hide').style.display='none'; document.getElementById('show2').style.display='block'" style="border-radius: 0.25rem;">
	    						<label for="password" class="form__label">Hasło</label>
      						<i class="fas fa-eye-slash" id="eye" style="cursor: pointer;"></i>
  							</div>
  							<div style="height: 30px;">
	   						...
	   						<div class="d-flex justify-content-center">
	   							<button class="btn btn-l rounded" type="button" onclick="location.href=''" style="width: 320px">Zarejestruj się</button>
	   						</div>
	  					</form>
	  				</div>
	  				<hr class="my-3" style="border-top: 1px solid #e0e0e0">
	  				<div class="d-flex justify-content-center pb-2">
	   				...
	   				<div class="d-flex justify-content-center pt-3">
	   					<div>
	   						Masz już konto?
	   						<a class="register-line" href="login.php" style="text-decoration: none;">Zaloguj się</a>
	   					</div>
	   				</div>
	   				<hr class="my-3" style="border-top: 1px solid #e0e0e0">
	   				<div class="d-flex justify-content-center pt-2" style="font-size: 10px">
	   					<div>
	   						Rejestrując się akceptujesz
	   						<a class="register-line" href="page.php#polityka" style="text-decoration: none;">politykę prywatności</a>
	   						i
	   						<a class="register-line" href="page.php#regulamin" style="text-decoration: none;">regulamin</a>
	   					</div>
	   				</div>
      		</div>
      		<div class="col"></div>
    ...
    <footer style="background: rgb(111,87,73); background: linear-gradient(270deg, rgba(111,87,73,1) 0%, rgba(124,97,82,1) 40%, rgba(99,77,65,1) 100%); box-shadow: 0px 4px 24px 0px rgba(124, 97, 82, 1);">				<div class="container p-4">
			  	<div class="row">
